        ...
        <form id="new-request-form" onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 sm:space-y-5 overscroll-contain touch-pan-y">
          ...
          <div className="bg-slate-950/80 p-4 rounded-2xl border border-slate-800 space-y-3 sm:space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 sm:gap-4">
              ...
              <div className="space-y-1.5">
                <label className="block text-xs font-semibold text-slate-300">مكان الاستلام (من):</label>
              ...
              {/* Delivery Emirate */}
              <div className="space-y-1.5">
                <label className="block text-xs font-semibold text-slate-300">مكان التسليم (إلى):</label>
                <div className="relative">
                  <select
          ...
          <div className="bg-slate-950/80 p-4 rounded-2xl border border-slate-800 space-y-3 sm:space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1.5">الوزن التقديري</label>
                <input
                  type="text"
                  value={packageWeight}
          ...
          <div className="bg-slate-950/80 p-4 rounded-2xl border border-slate-800 space-y-3 sm:space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1.5">موعد التوصيل المطلوب</label>
              <input
                type="text"
                value={deliveryDate}
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1.5">ملاحظات وتعليمات خاصة للسائقين</label>
              <textarea
                rows={2}
                value={notes}
