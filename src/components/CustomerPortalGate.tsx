        ...
        >
          <div className="space-y-4 relative z-10">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-bold text-zinc-400 bg-zinc-900 px-2.5 py-1 rounded-full border border-zinc-700">
                لدي حساب سابق
              </span>
            </div>
          ...
          <div className="pt-6 relative z-10">
            <button
              ...
              className="w-full bg-zinc-900 hover:bg-zinc-800 text-white font-bold py-3.5 px-5 rounded-2xl border border-zinc-700 hover:border-zinc-500 shadow-lg transition-all text-xs sm:text-sm flex items-center justify-center gap-2 active:scale-95"
            >
