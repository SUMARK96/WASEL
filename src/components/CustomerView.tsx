                            ...
                            >
                              ...
                              <div className="bg-slate-950 p-2.5 rounded-xl border border-slate-800/80 space-y-1.5 text-xs">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5">
                                  <div className="flex items-center justify-between bg-emerald-500/10 border border-emerald-500/20 px-2.5 py-1.5 rounded-lg text-emerald-400 text-[11px]">
                                  ...
                                  <div className="flex items-center justify-between bg-blue-500/10 border border-blue-500/20 px-2.5 py-1.5 rounded-lg text-blue-400 text-[11px]">
                              ...
                              <div className="grid grid-cols-2 gap-2">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center justify-center gap-1 bg-emerald-500/15 hover:bg-emerald-500 hover:text-slate-950 text-emerald-400 font-bold py-2 px-2 rounded-xl text-xs border border-emerald-500/30 transition-all active:scale-95"
                                ...
                                <a
                                  ...
                                  className="flex items-center justify-center gap-1 bg-blue-500/15 hover:bg-blue-600 hover:text-white text-blue-400 font-bold py-2 px-2 rounded-xl text-xs border border-blue-500/30 transition-all active:scale-95"
