    ...
    <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-md flex items-end sm:items-center justify-center p-0 sm:p-4 overflow-hidden">
      <div className="bg-slate-900 border-t sm:border border-slate-800 rounded-t-3xl sm:rounded-3xl max-w-xl w-full max-h-[92dvh] sm:max-h-[88vh] flex flex-col overflow-hidden shadow-2xl animate-in slide-in-from-bottom duration-300">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 sm:space-y-5 overscroll-contain">
          ...
          {/* STAGE: SUCCESS */}
          {stage === 'success' && (
            <div className="p-6 sm:p-8 text-center flex flex-col items-center justify-center space-y-4 animate-in zoom-in-95 duration-200">
              ...
              <div className="space-y-1">
                <h4 className="text-lg sm:text-2xl font-black text-white">تم التحقق من نجاح الدفع عبر زينة! 🎉</h4>
                <p className="text-emerald-400 font-bold text-xs sm:text-sm">تم تجديد اشتراكك الموحد بنجاح وتمديده لمدة 30 يوماً إضافية.</p>
              </div>

              <div className="bg-slate-950/80 p-4 rounded-2xl border border-slate-800 w-full text-right text-xs space-y-2">
                ...
                <div className="flex items-center justify-between text-slate-300">
                  ...
                  <span className="font-bold text-emerald-400">{plan.price} AED</span>
                </div>
                <div className="flex items-center justify-between text-slate-300">
              ...
              >
                <span>متابعة تقديم العروض للعملاء</span>
          ...
          {/* STAGE: LINK_OPENED (Awaiting user confirmation after returning from Ziina) */}
          {stage === 'link_opened' && (
            <div className="space-y-4 animate-in fade-in duration-200">
              <div className="bg-blue-950/40 border border-cyan-500/40 rounded-2xl p-4 sm:p-5 space-y-3">
                ...
                <div className="text-xs text-slate-300 bg-slate-950/80 p-3.5 rounded-xl border border-slate-800 space-y-1.5 leading-relaxed">
                  ...
                  <div className="flex items-center gap-2 text-cyan-300 font-bold">
                    <span>2.</span>
                    <span>عند الانتهاء بنجاح، اضغط على زر "تأكيد والتحقق من نجاح الدفع" أدناه لتجديد اشتراكك فوراً.</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2.5 pt-2">
                ...
                >
                  ...
                  <span>✅ لقد أتممت الدفع بنجاح (التحقق وتجديد الاشتراك)</span>
                </button>
            ...
            <>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-3.5 rounded-xl text-xs text-amber-300 space-y-1">
                <div className="flex items-center gap-1.5 font-bold">
                  ...
                  <span>سياسة تفعيل وتجديد الاشتراك:</span>
                </div>
                <p className="text-slate-300 text-[11px] leading-relaxed">
                  يتم تجديد اشتراك الحساب فقط بعد التحقق من إتمام الدفع بنجاح عبر بوابة زينة. في حال تعذر أو فشل الدفع، يظل الاشتراك معلقاً حتى إتمام السداد.
                </p>
              </div>
